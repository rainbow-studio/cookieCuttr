...
Quick start
------------
Install with Bower: `bower install git://github.com/rainbow-studio/cookieCuttr.git --save-dev`.
...
$(document).ready(function () {
  $.cookieCuttr({
    cookieDomain: "hosts without www.",
    cookiePolicyLink: 'policy-page.html',
  });
});
```

For any JavaScript you want to enable, you need to wrap the following if statement around it.
...
Alternatively, you can do the following until cookies are accepted.
...
For options, see the jquery.cookiecuttr.js.
